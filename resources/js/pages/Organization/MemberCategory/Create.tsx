...
import { MemberCategoryFormData } from '@/types/memberCategory';

export default function Create({ auth }: PageProps) {
    const { data, setData, post, processing, errors } = useForm<MemberCategoryFormData>({
        category_name: '',
        category_name_bn: '',
        description: '',
        is_active: true,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/member-categories');
    };

    return (
        <AdminLayout>
            <Head title="Create Member Category" />
            ...
            <div className="p-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">Create Member Category</h1>
                        <p className="mt-1 text-sm text-gray-500">Add a new member category to your organization</p>
                    </div>
