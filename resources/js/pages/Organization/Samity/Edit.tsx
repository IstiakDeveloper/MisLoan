...
import { Samity, SamityFormData } from '@/types/samity';
...
export default function Edit({ auth, samity, branches }: Props) {
    const { data, setData, put, processing, errors } = useForm<SamityFormData>({
        branch_id: samity.branch_id,
        samity_code: samity.samity_code,
        samity_name: samity.samity_name,
        samity_name_bn: samity.samity_name_bn || '',
        description: samity.description || '',
        is_active: samity.is_active,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/samities/${samity.id}`);
    };

    return (
        <AdminLayout>
            <Head title="Edit Samity" />
            ...
            <div className="p-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">Edit Samity</h1>
                        <p className="mt-1 text-sm text-gray-500">Update samity information</p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
                                ...
                                >
                                    {processing ? 'Updating...' : 'Update Samity'}
                                </button>
                            </div>
                        </form>
                    </div>
