                ...
                <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 text-white rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
                    ...
                    <div className="space-y-4 max-w-3xl relative z-10">
                        ...
                        <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
                            প্রতিদিন সিস্টেম সক্রিয় CSO ও এরিয়াগুলো স্থিতিশীল আইডি অনুসারে সাইক্লিকভাবে ভাগ করে। শুক্রবার সাপ্তাহিক ছুটি হিসেবে বাদ যায়, তাই বৃহস্পতিবার ও শনিবার একই এরিয়া পুনরাবৃত্ত হয় না। কোনো CSO আগের ডিউটি দিনে যে এরিয়াগুলো পেয়েছেন, পরের ডিউটি দিনে সেগুলো আর পাবেন না। হেড অফিস চাইলে যেকোনো দিন ম্যানুয়াল ওভাররাইড করতে পারবে।
                        </p>
                    </div>
                </div>
            </div>
