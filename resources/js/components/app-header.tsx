                ...
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        <a
                            ...
                            target="_self"
                            className="group inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-900 text-white hover:bg-emerald-600 dark:bg-emerald-600 dark:hover:bg-emerald-500 font-bold text-xs shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 mr-2"
